...
public class PatentExamineServiceImpl implements PatentExamineService {
     ...
     * @return
     */
    @RequestMapping("/addPatentExamine")
    @Override
     ...
     * @return
     */
    @RequestMapping("/selectPatentExamineByCondition")
    @Override
...
//            List<CacheUser> cacheUsers = cacheUserMapper.findAllCacheUser();
     ...
     * @return
     */
    @RequestMapping("/delPatentExamineById")
    @Override
     ...
     * @return
     */
    @RequestMapping("/findPatentExamineById")
    @Override
     ...
     * @return
     */
    @RequestMapping("/selectAllPatentExamineByCondition")
     ...
     * @return
     */
    @RequestMapping("/findPersonalPatentExamineMessage")
