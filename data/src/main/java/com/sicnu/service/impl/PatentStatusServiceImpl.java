...
public class PatentStatusServiceImpl implements PatentStatusService {
    ...
    private Result rs;
    @RequestMapping("/addPatentStatus")
    @Override
    ...
    @RequestMapping("/delPatentStatus")
    @Override
    ...
    @RequestMapping("/findAllPatentStatus")
    @Override
    ...
    @RequestMapping("/updatePatentRange")
    @Override
