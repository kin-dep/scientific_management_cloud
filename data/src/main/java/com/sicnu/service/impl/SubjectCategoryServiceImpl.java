...
public class SubjectCategoryServiceImpl implements SubjectCategoryService {
    ...
    @Override
    @RequestMapping("/addSubjectCategory")
    ...
    @Override
    @RequestMapping("/delSubjectCategory")
    ...
    @Override
    @RequestMapping("/findAllSubjectCategory")
    ...
    @Override
    @RequestMapping("/selectSubjectCategory")
    ...
    @Override
    @RequestMapping("/updateSubjectCategory")
