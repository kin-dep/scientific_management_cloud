...
public class ResearchTypeServiceImpl implements ResearchTypeService {
    ...
    @Override
    @RequestMapping("/addResearchType")
    ...
    @Override
    @RequestMapping("/delResearchType")
    ...
    @Override
    @RequestMapping("/findAllResearchType")
    ...
    @Override
    @RequestMapping("/updateResearchType")
