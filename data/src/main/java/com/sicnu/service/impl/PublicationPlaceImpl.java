...
@Slf4j
@RestController
@RequestMapping("/publicationPlace")
...
public class PublicationPlaceImpl implements PublicationPlaceService {
    ...
    @Override
    @RequestMapping("/addPublicationPlace")
    ...
    public Result addPublicationPlace(String pp_name) {
        try {
            ...
            if (publicationPlace==null){
                ...
                redisUtil.del("publicationPlaces");
    ...
    @Override
    @RequestMapping("/delPublicationPlace")
    ...
    @Override
    @RequestMapping("/findAllPublicationPlace")
    ...
    @Override
    @RequestMapping("/updatePublicationPlace")
